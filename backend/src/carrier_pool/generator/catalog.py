...
def _carriers() -> tuple[CarrierDefinition, ...]:
    ...
    return (
        ...
        _carrier("HD-C-402", "hd-broker", "Central Haul", all_equipment),
        ...
        _carrier("BO-C-606", "bo-broker", "Coastal Van", reefer),
...
def _ranking_holdouts() -> tuple[RankingHoldoutDefinition, ...]:
    ...
    rows = (
        ...
        ("BO-3002", "BO-C-607", ("SPARSE", "BROADER_LANE", "KNOWN_EQUIPMENT")),
        ("BO-3003", "BO-C-605", ("SPARSE", "METRO_CORRIDOR", "KNOWN_EQUIPMENT")),
        ("BO-3004", "BO-C-605", ("SPARSE", "DISTANCE_EQUIPMENT", "KNOWN_EQUIPMENT")),
...
def _scenarios() -> tuple[ScenarioDefinition, ...]:
    ...
    rows = (
        ...
        (
            ...
            ("BO-9001",),
            (),
            "Day 11 rich Houston to San Antonio reefer target.",
            "Near-exact history supports a high-evidence price and ranking.",
        ...
        (
            ...
            ("HD-9001",),
            (),
            "Day 11 sparse-local, broader-fallback target.",
            "Sparse local evidence blends with regional history at medium confidence.",
